...
public class SwipeListView extends RecyclerView {
    ...
    */
    ...
    private void init(AttributeSet attrs) {
        ...
        float leftDisatance = 0;
        float rightDisatance = 0;
        ...
        if (attrs != null) {
            ...
            leftDisatance = styled.getDimension(R.styleable.SwipeListView_leftDistance, 0);
            rightDisatance = styled.getDimension(R.styleable.SwipeListView_rightDistance, 0);
        ...
        touchListener.setRightDistance(rightDisatance);
        touchListener.setLeftDistance(leftDisatance);
