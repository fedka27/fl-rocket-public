...
import wash.rocket.xor.rocketwash.adapters.ChoiseServicesRecyclerViewAdapter;
 ...
 */
public class ChoiseServicesFragment extends BaseFragment {

    private static final String TAG = "NearestWashServices";
    ...
    private ChoiseServicesRecyclerViewAdapter adapter;
    ...
    public ChoiseServicesFragment() {
    }

    public static ChoiseServicesFragment newInstance(int id_service, int id_car_model, ArrayList<ChoiseService> list) {
        ChoiseServicesFragment fragment = new ChoiseServicesFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        adapter = new ChoiseServicesRecyclerViewAdapter(list);
