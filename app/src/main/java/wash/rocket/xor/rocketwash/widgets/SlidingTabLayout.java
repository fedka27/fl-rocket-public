...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void addTab(String title, String desc, boolean selected) {
        View tabView = null;
        TextView tabTitleView = null;
                ...
                if (v == mTabStrip.getChildAt(i)) {
                    ...
                    if (mViewPager != null) {
                        ...
                        for (int j = 0; j < mTabStrip.getChildCount(); j++) {
                            mTabStrip.getChildAt(i).setSelected(j == i);
                        }
                    }
                    return;
                }
    ...
    private void indicateTab(int tabIndex, int positionOffset) {
        final int tabStripChildCount = mTabStrip.getChildCount();
        if (tabStripChildCount == 0 || tabIndex < 0 || tabIndex >= tabStripChildCount) {
            return;
        }
    ...
    public void setOnTabSelected(OnTabSelected value) {
        mOnTabSelected = value;
    }
