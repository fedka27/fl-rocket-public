...
public class ReserveCompletedRequest extends GoogleHttpClientSpiceRequest<ReservedResult> {

    private String session_id;
    private String url;

    public ReserveCompletedRequest(String session_id) {
    ...
    public ReservedResult loadDataFromNetwork() throws IOException {
        ...
        String uri = bld
                .appendQueryParameter("scope", "completed")
                .build().toString();
